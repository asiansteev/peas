function love.load()
  ...
  was_firing = false
      ...
      t = Tack:new(love.graphics.newImage("images/tack.png"), 100, 100)
      t.body:applyLinearImpulse(10, 10, 10, 10)
end
...
function love.update(dt)
  ...
  if love.keyboard.isDown("a") then
    if bullet_timer <= 0 then
      ...
      b.body:applyLinearImpulse(10, 0, 0, 0)
...
function love.draw()
  ...
  love.graphics.draw(t.graphics, t.body:getX(), t.body:getY())
  ...
  for i, v in ipairs(bullets) do
    ...
    love.graphics.draw(bullets[i].graphics,
                       bullets[i].body:getX(),
                       bullets[i].body:getY()
                      )
  end
